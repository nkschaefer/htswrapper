...
#include <stdlib.h> 
#include <ctype.h>
#define K_AR_SIZE (15) // default length of the array size of the kmer structure
...
void* kmer_tree_lookup_continue( const char*, const kmer_tree_p, int, size_t*);
void* kmer_tree_lookup_init(const char*, const kmer_tree_p, int, size_t*);
void* kmer_tree_lookup_aux(const char*, const kmer_tree_p, int, size_t*); 
...
int kmer2inx_continue( const char*, const size_t, size_t*, int, int);
